  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-[#050505] text-white overflow-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col relative overflow-hidden bg-gradient-to-b from-neutral-900/10 to-black">
          ...
          {activeTab === 'contact' && (
             <div className="max-w-5xl mx-auto py-10 space-y-8 animate-in slide-in-from-bottom-6 duration-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                   <div className="bg-neutral-900/80 p-10 rounded-[2.5rem] border border-white/5 text-center shadow-xl">
                   ...
                   <div className="bg-neutral-900/80 p-10 rounded-[2.5rem] border border-white/5 text-center shadow-xl">
                      ...
                      <p className="text-lg italic text-neutral-100 font-black tracking-tighter">{t[lang].waNum}</p>
                   </div>
                   <div className="bg-neutral-900/80 p-10 rounded-[2.5rem] border border-white/5 text-center shadow-xl">
        ...
        {currentSong && <div className="fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-2xl border-t border-white/5 h-28 px-4 md:px-10 z-50 shadow-2xl"><Player song={currentSong} isPlaying={isPlaying} setIsPlaying={setIsPlaying} /></div>}
      </main>
    </div>
  );
};
